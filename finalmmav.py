...
k1r= ((Mmch4/(Mmch4+Mmo2+Mmo2))*cvm) + ((2*Mmo2/(Mmch4+Mmo2+ Mmo2))*cvo)
k2r= ((Mmch4/(Mmch4+Mmo2+Mmo2))*cpm) + ((2*Mmo2/(Mmch4+Mmo2+Mmo2))*cpo)
kr= k2r/k1r
...
k1p= ((2*Mh20/(Mh20+ Mh20+ Mco2))*cvw) + ((Mco2/(Mh20+Mh20+Mco2))*cvcd)
k2p= ((2*Mh20/(Mh20+Mh20+Mco2))*cpw) + ((Mco2/(Mh20+Mh20+Mco2))*cpcd)
kp= k2p/k1p
vi= 0
